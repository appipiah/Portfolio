...
const excelMindSections = [
  ...
  },
  {
    ...
    label: "Approach",
    body: [
      "**Follow the data, not the screen.** Before opening Figma I broke each feature into workflows and traced what it touched. Linking teachers to their subjects and assigned classes meant timetable creation could surface only valid options instead of asking someone to remember the rules.",
      "**Configure, don't prescribe.** Wherever schools differed, I designed for setup rather than assumption — academic structures, grading systems, fee schedules and promotion requirements are things a school defines, not things the product decides.",
      "**Make it lighter than the work.** School administration is long hours of repetitive tasks. I used colour and spacing deliberately so the platform felt lighter than the job it supported.",
